const PUZZLES = [
    {
        groups: [
            { category: "THINGS SHE DOES WITHOUT REALISING", words: ["FLIRT", "SLEEP", "LOUD", "ZONES OUT"], color: "yellow"} ,
            { category: "THINGS TRISHA HATES", words: ["FIREWORKS", "COCKROACH", "SCARY HOUSE", "MEN"], color: "green" },
            { category: "THINGS YOU LOVE", words: ["KURKURE", "BTS", "ANIMALS", "DRIVING"], color: "blue" },
    ...
    /*{
        groups: [
            { category: "THINGS SHE DOES WITHOUT REALISING", words: ["FLIRT", "SLEEP", "LOUD", "ZONES OUT"], color: "yellow" },
            { category: "TRISHA ENIGMAS", words: ["TEMPERATURE", "", "ESPRESSO", "CAPPUCCINO"], color: "green" },
